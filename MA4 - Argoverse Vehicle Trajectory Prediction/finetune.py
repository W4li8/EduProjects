...
parser.add_argument("--lr", default="3e-5", type=str)
parser.add_argument("--prop1", default=4, type=int) # original data
parser.add_argument("--prop2", default=0, type=int) # attack type 1
parser.add_argument("--prop3", default=1, type=int) # attack type 2
parser.add_argument("--prop4", default=1, type=int) # attack type 3
parser.add_argument("--attack_range", default=7, type=int)
parser.add_argument("--dataset_size", default=10000, type=int)

#! added this identifier to log file, see lanegcn_nce_tests spreadsheet in results folder for meaning
experiment_id = 'Neo30-NoFilter-CloudR3'
...
def main():
    ...
    load_pretrain(net, ckpt["state_dict"], strict=False)  #! added strict=False
