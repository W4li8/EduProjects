...
parser.add_argument("--prop2", default=0, type=int) # attack type 1 - 0, was 0
parser.add_argument("--prop3", default=1, type=int) # attack type 2 - 0, was 1
parser.add_argument("--prop4", default=1, type=int) # attack type 3 - 0, was 1
parser.add_argument("--attack_range", default=7, type=int)
parser.add_argument("--dataset_size", default=10000, type=int) # was 10000

experiment_id = '4011lr'
