...
parser.add_argument("--save_addr", type=str, default="")                        # directory for saving visualizations
...
def main():
    ...
    for scenario in tqdm(range(args.n_scenarios)):
        ...
        original_HOR, original_SOR = augmentor.attack(scenario, default_params, save_addr)
