...
initial_joint_configuration = [-0.2; 0.4; 0; 0.1];
...
q_mid = q_mid + deg2rad(10); % add 10deg to all joints
...
optimal_solution_final.Topt  = [optimal_solution_full.Topt(1:disturbance_idx), time_left + optimal_solution_after_disturbance.Topt];
